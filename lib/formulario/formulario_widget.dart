...
class _FormularioWidgetState extends State<FormularioWidget> {
  ...
  void initState() {
    ...
    _model.nombredelatareagfController ??= TextEditingController();
    _model.shortBioController ??= TextEditingController();
    _model.ubicacionServicioController ??= TextEditingController();
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              16.0, 8.0, 16.0, 0.0),
                          child: TextFormField(
                            controller: _model.nombredelatareagfController,
                            ...
                            style: FlutterFlowTheme.of(context)
                                ...
                                .override(
                                  fontFamily: 'Poppins',
                                  color: Color(0xFF071115),
                                  fontSize: 10.0,
                                ),
                            textAlign: TextAlign.start,
                            validator: _model
                                .nombredelatareagfControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                          ...
                          Container(
                            ...
                            child: Stack(
                              children: [
                                ...
                                Align(
                                  alignment: AlignmentDirectional(-0.43, -0.03),
                                  child: Image.network(
                                ...
                                Align(
                                  alignment: AlignmentDirectional(0.27, -0.03),
                                  child: Image.network(
                            ...
                            children: [
                              Expanded(
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.ubicacionServicioController,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                    ...
                                    validator: _model
                                        .ubicacionServicioControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                            ...
                            children: [
                                  ...
                                  child: Padding(
                                    ...
                                    child: Stack(
                                      children: [
                                        ...
                                        Align(
                                          alignment:
                                              AlignmentDirectional(0.77, 0.04),
                                          child: InkWell(
                                            onTap: () async {
                              ...
                              Padding(
                                ...
                                child: Theme(
                                  ...
                                  child: CheckboxListTile(
                                    value: _model.materialesValue ??= true,
                                    onChanged: (newValue) async {
                                      setState(() =>
                                          _model.materialesValue = newValue!);
                                    },
                                    title: Text(
                                      'incluir materiales',
                                      style: FlutterFlowTheme.of(context)
                              ...
                              Padding(
                                ...
                                child: Theme(
                                  ...
                                  child: CheckboxListTile(
                                    value: _model.inspeccionValue ??= true,
                                    onChanged: (newValue) async {
                                      setState(() =>
                                          _model.inspeccionValue = newValue!);
                                    },
                                    title: Text(
                                      'inspeccion',
                                      style: FlutterFlowTheme.of(context)
